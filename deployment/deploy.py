...
if args.delete:
    ...
    client = vertexai.Client(
        project="cas-test-project-268620",
        location="us-central1",
    ...
    remote_app = client.agent_engines.create(
        agent=app,
        name="projects/786157197811/locations/us-central1/reasoningEngines/8042493250088468480",
        config={
          "identity_type": types.IdentityType.AGENT_IDENTITY,
          "requirements": [AGENT_WHL_FILE],
          "extra_packages": [AGENT_WHL_FILE],
          "staging_bucket": "gs://adk-test--1bucket",
    ...
    for event in remote_app.stream_query(
        ...
        if event.get("content", None):
            print(
                f"Agent deployed successfully under resource name: {remote_app.name}"
            )
